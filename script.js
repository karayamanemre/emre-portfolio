...
const portfolio = [
  ...
  },
  {
    ...
    job: 'Front-End',
    year: '2019',
    cardInfo: 'A blog website that provides reviews of books and is updated on a daily basis with fresh posts.',
    technologies: ['html', 'css', 'wordpress', 'javascript'],
    buttonText: 'See More',
    modalInfo: 'A blog website that provides reviews of books and is updated on a daily basis with fresh posts. Designed in WordPress.',
    modalSeeButtonText: 'See Live',
    modalSeeButtonIcon: '',
    modalSourceButtonText: 'See Source',
    modalSourceButtonIcon: '',
